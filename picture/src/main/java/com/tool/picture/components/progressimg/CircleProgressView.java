...
/**
 * @作者          吴孝然
 * @创建日期      2019/1/18 11:04
 * @描述          进度展示
 **/
public class CircleProgressView extends ProgressBar {

    private int mReachBarSize = Util.dp2px(getContext(), 2); // 未完成进度条大小
    private int mNormalBarSize = Util.dp2px(getContext(), 2); // 未完成进度条大小
    private int mReachBarColor = Color.parseColor("#108ee9"); // 已完成进度颜色
    private int mNormalBarColor = Color.parseColor("#FFD3D6DA"); // 未完成进度颜色
    private int mTextSize = Util.sp2px(getContext(), 14); // 进度值字体大小
    ...
    private int mOuterSize = Util.dp2px(getContext(), 1); // 外层圆环宽度
    ...
    public void setReachBarSize(int reachBarSize) {
        mReachBarSize = Util.dp2px(getContext(), reachBarSize);
        invalidate();
    }
    ...
    public void setNormalBarSize(int normalBarSize) {
        mNormalBarSize = Util.dp2px(getContext(), normalBarSize);
        invalidate();
    }
    ...
    public void setTextSize(int textSize) {
        mTextSize = Util.sp2px(getContext(), textSize);
        invalidate();
    }
    ...
    public void setRadius(int radius) {
        mRadius = Util.dp2px(getContext(), radius);
        invalidate();
    }
    ...
    public void setInnerPadding(int innerPadding) {
        mInnerPadding = Util.dp2px(getContext(), innerPadding);
        int mInnerRadius = mRadius - mOuterSize / 2 - mInnerPadding;
        rectInner = new RectF(-mInnerRadius, -mInnerRadius, mInnerRadius, mInnerRadius);
        invalidate();
    }
    ...
    public void setOuterSize(int outerSize) {
        mOuterSize = Util.dp2px(getContext(), outerSize);
        invalidate();
    }
