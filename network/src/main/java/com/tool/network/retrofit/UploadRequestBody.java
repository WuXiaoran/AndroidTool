...
public class UploadRequestBody extends RequestBody {
    ...
    public UploadRequestBody(RequestBody requestBody, ResponseCallback callback) {
        this(requestBody, callback, callback.getTag());
    }

    public UploadRequestBody(RequestBody requestBody, ResponseCallback callback, Object tag) {
    ...
    public UploadRequestBody setTag(Object tag) {
        Tag = tag;
        return this;
    }
