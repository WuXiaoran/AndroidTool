package com.tool.network.retrofit.subscribers;
...
import com.tool.network.retrofit.download.DownLoadListener.DownloadProgressListener;
import com.tool.network.retrofit.download.DownState;
